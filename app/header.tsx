...
<nav className="">
    <div className="br-primaryColor flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            <Link href="#" className="text-gray-800  hover:bg-primaryColor focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 
                                      dark:text-secondaryColor  dark:hover:bg-keyColor dark:hover:text-primaryColor focus:outline-none dark:focus:ring-gray-800"
                >Login</Link>
            <Link href="#" className="text-primaryColor bg-keyColor hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 
                                      dark:bg-keyColor dark:hover:bg-keyColor focus:outline-none dark:focus:ring-blue-800"
                >Sign up</Link> 
